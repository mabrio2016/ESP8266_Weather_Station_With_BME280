...
const int buttonPin = 0;     // Flash Button
int buttonState = 0;  
...
void handle_OnConnect() {
  ...
  if (buttonState == HIGH) {
    ...
    ShowText1 (str, "TempC");
    sprintf(str, "%.1f", Fahrenheit_out);
    ShowText1 (str, "TempF");
    sprintf(str, "%.1f", humidity_out);
    ShowText1 (str, "Humdt");
    sprintf(str, "%.1f", pressure_out);
    ShowText1 (str, "Press");
  } 
  else {
    ssd1306_setColor(RGB_COLOR8(0, 0, 250));
    ...
    ShowText1 (str, "TempF");
    sprintf(str, "%.1f", humidity_in);
    ShowText1 (str, "Humdt");
    sprintf(str, "%.1f", pressure_in);
    ShowText1 (str, "Press");
  }
}
